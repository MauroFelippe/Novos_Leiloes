...
diretorio_base = r"C:\\Users\\4006704\\Light\\BI ACR ACL CE - General\\Contratos 2025\\23º LEILÃO DE ENERGIA EXISTENTE A-4"
...
df_filtrado = df[df["LEILÃO"] == "23º LEILÃO DE ENERGIA EXISTENTE A-4"].copy()
